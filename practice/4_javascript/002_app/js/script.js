window.onload = function () {
    ...
    document.getElementById("sendBtn").onclick = function () {
		...
		if (arrDay[2].search(template) != 0) {document.getElementById("forInner").innerHTML = "Неверная дата!";}
		else if (age<18) {document.getElementById("forInner").innerHTML = "Извините, но Вам нет 18!";}
		else if (age>90) {document.getElementById("forInner").innerHTML = "Извините, но Вам нет 18!";}
